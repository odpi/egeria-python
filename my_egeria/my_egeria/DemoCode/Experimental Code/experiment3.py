""" python
   ...
   This file provides a utility function for my_egeria.
    ...
    This file is starting to test the Tech_type process, initially just displaying, and
    later allowing for inputting required parameters and executing the process flow
