...
def process_blueprint_upsert_command(egeria_client: SolutionArchitect, element_dictionary: dict, txt: str,
    ...
    print(Markdown(f"{pre_command} `{object_type}{object_action}` for term: `\'{term_name}\'` with directive: `{directive}`"))
