...
class ExternalReferences(ServerClient):
    ...
    * CitedDocumentProperties
    ...
    def find_external_references(self, search_string: str = '*', classification_names: str = None,
                                 metadata_element_subtypes: list[str] = EXTERNAL_REFERENCE_TYPES, starts_with: bool = True,
        ...
        """
        return asyncio.get_event_loop().run_until_complete(
            self._async_find_external_references(search_string, classification_names, metadata_element_subtypes,
