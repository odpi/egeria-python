...
from pyegeria.core._validators import validate_user_id


class Platform(BasePlatformClient):
    """
    Client for Egeria Platform Services.

    The Platform Services provide methods to manage the OMAG Server Platform
    and its hosted servers, including activating/deactivating servers and
