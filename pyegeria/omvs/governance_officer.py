...
class GovernanceOfficer(ServerClient):
    ...
    def __init__(self, view_server: str = None, platform_url: str = None, user_id: Optional[str] = None, user_pwd: Optional[str] = None,
                 token: Optional[str] = None, timeout: int = None, **kwargs):
        ServerClient.__init__(self, view_server, platform_url, user_id=user_id, user_pwd=user_pwd, token=token, timeout=timeout, **kwargs)
    ...
    async def _async_create_data_lens(self, body: dict | NewElementRequestBody) -> str:
        ...
        Body structure like:
        {
          ...
          "properties": {
            ...
            "dataValidityStartTime" : "{{$isoTimestamp}}",
            "dataValidityEndTime" : "{{$isoTimestamp}}",
            "dataCoverageStartTime" : "{{$isoTimestamp}}",
            "dataCoverageEndTime" : "{{$isoTimestamp}}",
            "minLongitude" : 0,
            "minLatitude" : 0,
            "maxLongitude" : 0,
            "maxLatitude" : 0,
    ...
    @dynamic_catch
    async def _async_find_governance_definitions(
        self,
        search_string: str = "*",
...
-------
    ...
    @dynamic_catch
    def find_governance_definitions(
        self,
        search_string: str = "*",
