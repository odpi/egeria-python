...
class ActorManager(ServerClient):
    ...
    @dynamic_catch
    async def _async_find_actor_profiles(self, search_string: str = "*", classification_names: list[str] = [],
    ...
    def find_actor_profiles(self, search_string: str = '*', classification_names: str = None,
                            metadata_element_subtypes: list[str] = ["ActorProfile"], starts_with: bool = True,
