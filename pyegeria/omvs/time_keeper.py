...
class TimeKeeper(ServerClient):
    ...
    def _generate_context_event_output(
        ...
        **kwargs,
        ...
        return self._generate_formatted_output(
            ...
            element_type_name=element_type_name or "ContextEvent",
            output_format=output_format,
            report_spec=report_spec,
            extract_properties_func=self._extract_context_event_properties,
            **kwargs,
        )
    ...
    async def _async_get_context_events_by_name(
        self,
        name: str = None,
        metadata_element_type_name: str | None = "ContextEvent",
        ...
        report_spec: Optional[str | dict] = "ContextEvents",
        ...
        **kwargs,
        ...
        ----------
        name : str, optional
            The name to find in the properties.
    ...
    async def _async_get_context_event_by_guid(
        ...
        **kwargs,
        ...
        PyegeriaException
            If there are issues in communications, message format, or Egeria errors.
        """
        url = f"{self.platform_url}/servers/{self.view_server}/api/open-metadata/time-keeper/context-events/{guid}/retrieve"
        params = {
            "include_only_relationships": include_only_relationships,
            "skip_relationships": skip_relationships,
            "graph_query_depth": graph_query_depth,
