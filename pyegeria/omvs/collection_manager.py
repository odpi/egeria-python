...
class CollectionManager(ServerClient):
    ...
    async def _async_find_collections(self, search_string: str = "*", classification_names: list[str] = None,
        ...
        response = await self._async_find_request(url, _type="Collection", _gen_output=self._generate_collection_output,
                                                  ...
                                                  metadata_element_subtypes=metadata_element_subtypes, body=body)
    ...
    def find_collections(self, search_string: str = '*', classification_names: str = None,
        ...
        """
        return asyncio.get_event_loop().run_until_complete(
            self._async_find_collections(search_string, classification_names, metadata_element_subtypes,
