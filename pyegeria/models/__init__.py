...
from pyegeria.models.models import (
    ...
    AuthoredReferenceableProperties,
    SolutionBlueprintProperties,
    NestedDesignPatternProperties,
    SpecializedDesignPatternProperties,
    RelatedDesignPatternProperties,
