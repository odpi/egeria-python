...
EGERIA_USER = settings.User_Profile.user_name or os.environ.get("EGERIA_USER", "erinoverview")
EGERIA_USER_PASSWORD = settings.User_Profile.user_pwd or os.environ.get("EGERIA_USER_PASSWORD", "secret")
