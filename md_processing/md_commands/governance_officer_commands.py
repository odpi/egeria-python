        ...
        try:
            if object_action == "Update":
                ...
                #     return None
                    ...
                    print(json.dumps(create_body, indent=4))
...
@logger.catch
def process_gov_def_link_unlink_command(egeria_client: EgeriaTech, txt: str,
...
@logger.catch
def process_data_collection_list_command(egeria_client: EgeriaTech, txt: str,
                                         directive: str = "display") -> Optional[str]:
    """
