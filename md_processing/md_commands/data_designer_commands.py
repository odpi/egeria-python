...
from md_processing.md_processing_utils.extraction_utils import (
    extract_command, process_simple_attribute, process_name_list, process_element_identifiers, update_a_command
)
...
from md_processing.md_processing_utils.md_processing_constants import (
    ...
    SEARCH_LABELS, GUID_LABELS, TERM_RELATIONSHPS, ALWAYS, ERROR, INFO, WARNING, pre_command, EXISTS_REQUIRED
)
...
def process_data_spec_upsert_command(egeria_client: EgeriaTech, txt: str, directive: str = "display") -> Optional[str]:
    ...
    display_name_label = ['Data Spec Name', 'Display Name', 'Name']
    ...
    collection_type = process_simple_attribute(txt, ['Collection Type'], INFO)
