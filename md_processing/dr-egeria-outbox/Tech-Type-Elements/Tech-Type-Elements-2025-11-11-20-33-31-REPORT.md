...
# TechTypeElements Report - created at 2025-11-11 20:33
...
```mermaid
---
title: FileFolder - content-packs [63570d51-5377-4107-af96-dd38b70c197d]
---
flowchart TD
...
**~ {directoryName} ~**"}
1==>|"Sourced From"|2
3@{ shape: tag-doc, label: "*Archive File*
**SimpleEventCatalog**"}
1==>|"Nested File"|3
4@{ shape: tag-doc, label: "*Archive File*
**CocoGovernanceEngineDefinitions**"}
1==>|"Nested File"|4
5@{ shape: tag-doc, label: "*Archive File*
**Coco Pharmaceuticals Governance Program**"}
1==>|"Nested File"|5
6@{ shape: tag-doc, label: "*Archive File*
**PostgresContentPack**"}
1==>|"Nested File"|6
7@{ shape: tag-doc, label: "*Archive File*
**SimpleAPICatalog**"}
1==>|"Nested File"|7
8@{ shape: tag-doc, label: "*Archive File*
**ApacheKafkaContentPack**"}
1==>|"Nested File"|8
9@{ shape: stadium, label: "*Nested File*
**... plus 17 Items**"}
1-.->9
10@{ shape: div-rect, label: "*File Folder*
**deployments**"}
10==>|"Folder Hierarchy"|1
