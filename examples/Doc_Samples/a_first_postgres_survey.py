'''
This simple example demonstrates how to survey a file folder.
...
from pyegeria import AutomatedCuration, InvalidParameterException, PropertyServerException, UserNotAuthorizedException
...
try:
    c_client = AutomatedCuration(view_server, platform_url,
                                 user_id=user)
