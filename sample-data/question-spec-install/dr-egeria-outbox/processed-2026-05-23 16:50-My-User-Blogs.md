...
### Associated Elements
- **Collection Id**: `ReportType::My-User-Blogs`
- **Element Id**: `QuestionSpec::My-User-Blogs::1`

### Link Properties
- **Membership Rationale**: Link question spec 1 to My-User-Blogs report type.
...
### Associated Elements
- **Collection Id**: `QuestionSpec::My-User-Blogs::1`
- **Element Id**: `Question::show-me-my-blog-posts`

### Link Properties
- **Membership Rationale**: Add question to My-User-Blogs::1.
- **Membership Status**: VALIDATED
...
### Associated Elements
- **Collection Id**: `QuestionSpec::My-User-Blogs::1`
- **Element Id**: `Question::what-have-i-written-about`
...
- Derived from processing file My-User-Blogs.md on 2026-05-23 16:50
