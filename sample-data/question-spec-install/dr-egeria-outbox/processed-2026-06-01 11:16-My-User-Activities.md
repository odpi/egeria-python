...
### Associated Elements
- **Collection Id**: `ReportType::My-User-Activities`
- **Element Id**: `QuestionSpec::My-User-Activities::1`

### Link Properties
- **Membership Rationale**: Link question spec 1 to My-User-Activities report type.
...
### Associated Elements
- **Collection Id**: `QuestionSpec::My-User-Activities::1`
- **Element Id**: `Question::show-me-my-recent-activity`

### Link Properties
- **Membership Rationale**: Add question to My-User-Activities::1.
- **Membership Status**: VALIDATED
...
### Associated Elements
- **Collection Id**: `QuestionSpec::My-User-Activities::1`
- **Element Id**: `Question::what-have-i-been-working-on`
...
- Derived from processing file My-User-Activities.md on 2026-06-01 11:16
