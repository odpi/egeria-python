...
This is an initial, notional blueprint for preparing data and models in a local environment. 
I try to do as much in Jupyter Lab as I can - and will also run things in Docker if needed.
...
SolutionBlueprint::Local-Data-Prep-Blueprint-for-ML-OPs::0.1
## GUID
>	**Input Required**: False
