...
> Create a Unity Catalog table element from its Open Metadata catalog template.
...
>	**Description**: Unity Catalog table type.
...
>	**Description**: Data source format of the Unity Catalog table.

>	**Valid Values**: DELTA,CSV,JSON,AVRO,PARQUET,ORC,TEXT
